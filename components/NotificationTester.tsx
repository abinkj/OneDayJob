    ...
    try {
      ...
      if (perms.granted) {
        ...
        addTestResult(
          "Permissions",
          "error",
          `Permissions not granted. Status: ${perms.status}`
        );
      }
    } catch (error: any) {
  ...
  const testBackendNotification = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.EXPO_PUBLIC_API_URL}/notifications/test`,
        {
          method: "POST",
          headers: {
  ...
  const testVerificationCode = async () => {
    ...
    try {
      ...
      addTestResult(
        "Verification Code",
        "success",
        "Verification code notification sent"
      );
    } catch (error: any) {
      ...
      <View style={styles.section}>
        ...
        <View style={styles.statusItem}>
          ...
          <Text
            style={[
              styles.statusValue,
              permissions?.granted ? styles.success : styles.error,
            ]}
          >
