    ...
    return (
      <View style={arrivalStyles.container}>
        ...
        <Text style={arrivalStyles.subtitle}>
          Go to the Home screen and tap "I Have Arrived" on your job card when
          you reach the job site.
        </Text>
  ...
  if (arrivalStatus === "arrived" && !canStartWork) {
    return (
      <View style={arrivalStyles.container}>
        ...
        <Text style={arrivalStyles.subtitle}>
          Waiting for your employer to approve your arrival. You'll be notified
          once approved.
        </Text>
        <View
          style={[
            arrivalStyles.infoCard,
